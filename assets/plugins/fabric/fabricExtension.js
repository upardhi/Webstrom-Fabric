    ...
    fabric.PathText = fabric.util.createClass(fabric.Text, {
        ...
        */
        ...
        _observePathObject: function (_this) {
            ...
            if ((widget.scaleX == widget.scaleY) && (widget.scaleX != 1 || widget.scaleY != 1)) {
                fontSize = obj.nonScaledFontSize / (widget.scaleX); //TODO:: Have to remove dependancy of this
            }
                /*If widget scale X and scale Y is same and 1 and font size and non scaled font size value is not same then assigning non scaled font size value to font size value.
                * TODO: Have to remove dependency of it.
                */
            else if (fontSize != obj.nonScaledFontSize) {
                fontSize = obj.nonScaledFontSize;
            }
            if (!obj.showPath) {
                widget.opacity = 0.01;
            }            
        ...
        _set: function (prop, value) {
            if (prop == 'pathString' && typeof value != 'object' && this.canvas) {
                ...
                */
                ...
                this.callSuper('_set', prop, value);
                /*Following condition is defining that
                * Updating 'fontSize' property when 'nonScaledFontSize' property gets updated
                * Scaling font value to its original form
                */
                var fontSizeValue = value;
                if ((this.scaleX == this.scaleY) && (this.scaleX != 1 || this.scaleY != 1)) {
                    fontSizeValue = this.nonScaledFontSize / (this.scaleX); //TODO:: Have to remove dependancy of this
                }
                else if (fontSizeValue != this.nonScaledFontSize) {
                    fontSizeValue = this.nonScaledFontSize;
                }
                ...
                var fontSize = value;
                if ((this.scaleX == this.scaleY) && (this.scaleX != 1 || this.scaleY != 1)) {
                    fontSize = this.nonScaledFontSize / (this.scaleX); //TODO:: Have to remove dependancy of this
                }
                    /*If widget scale X and scale Y is same and 1 and font size and non scaled font size value is not same then assigning non scaled font size value to font size value 
                    * TODO: Have to remove dependency of it.
                    */
...
fabric.Object.prototype.drawControls = function (ctx) {
    ...
    if (this.hasRotatingPoint) {
        ...
        rotate.src = Artifi.Config.rotateImageUrl;
        ...
        ctx.drawImage(rotate, rotateLeft + customPadding, (rotateTop + (iconHeight / 2)), iconWidth, iconHeight);
    }
    ctx.restore();
    return this;
