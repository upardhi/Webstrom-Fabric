/*
 * This pluging added on date of 1/12/2015
 * This is replacement of version 1.2.13
 * This is addded because to add IText, PathText, NodeJS, features.
 */
...
(function (global) {
    ...
    fabric.Text = fabric.util.createClass(fabric.Object, /** @lends fabric.Text.prototype */ {
        ...
        _renderText: function (ctx, textLines) {
            ctx.save();
            /*TODO:Remove this code from here and add in FabricExtension
             * This is bug that have been fixed in 1.4.13 version of fabric
             * Have copied only opacity fix from this version.
             */
            this._setOpacity(ctx);
            this._setShadow(ctx);
            this._setupCompositeOperation(ctx);
